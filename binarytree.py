...
if __name__ == "__main__":
    ...
    # Take user input for inserting nodes into the binary tree
    print("Enter the values to insert into the binary tree (separate values by spaces):")
